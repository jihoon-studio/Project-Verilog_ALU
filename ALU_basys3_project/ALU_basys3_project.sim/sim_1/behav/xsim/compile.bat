...
REM
REM Generated by Vivado on Wed Dec 03 19:18:13 +0900 2025
...
echo "xvlog --incr --relax -prj top_ALU_basys3_vlog.prj"
call xvlog  --incr --relax -prj top_ALU_basys3_vlog.prj -log xvlog.log
