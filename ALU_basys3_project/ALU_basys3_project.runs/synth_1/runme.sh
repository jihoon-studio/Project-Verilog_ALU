...
HD_PWD='C:/Users/kccit/ALU_basys3_clean/ALU_basys3_clean.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ALU_basys3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ALU_basys3.tcl
