...
HD_PWD='C:/Users/kccit/ALU_basys3_clean/ALU_basys3_clean.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ALU_basys3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ALU_basys3.tcl -notrace
